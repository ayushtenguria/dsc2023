      ...
      <div className="carousel__txt">
        ...
        <div className="team__left gall_left">
          ...
          <div className="team__head2">
            There is more to representing art than selling art. The life of the
            gallery is dependent on the renewal and refreshment of its artists
            and dealers. When that stops happening, it's the end.
          </div>
          {/* <div 
